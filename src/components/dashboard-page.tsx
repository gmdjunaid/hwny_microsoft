  ...
  const secUpdates = [
    {
      ...
      date: "2024-01-15",
      impact: "High",
      summary: "Updated reporting standards for revenue recognition affecting SaaS companies.",
    },
    {
      id: 2,
      ...
      date: "2024-01-10",
      impact: "Medium",
      summary: "Enhanced cybersecurity disclosure requirements for public companies.",
    },
    {
      id: 3,
      ...
      date: "2024-01-08",
      impact: "Low",
      summary: "Voluntary ESG reporting guidelines for emerging growth companies.",
    },
  ]

  const competitorStocks = [
    { symbol: "PLTR", name: "Palantir", price: 18.45, change: 2.3, changePercent: 14.2 },
    { symbol: "SNOW", name: "Snowflake", price: 165.23, change: -3.2, changePercent: -1.9 },
    { symbol: "DDOG", name: "Datadog", price: 98.76, change: 1.8, changePercent: 1.9 },
    { symbol: "MDB", name: "MongoDB", price: 387.45, change: 8.9, changePercent: 2.4 },
  ]
      ...
      <div className="border-b border-gray-800">
        <div className="container mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                {["1M", "3M", "6M", "12M", "YTD"].map((range) => (
                  <Button
                    ...
                    className={
                      timeRange === range ? "bg-white text-black" : "border-gray-600 hover:bg-white/5 text-white"
                    }
                  >
                    {range}
                  </Button>
            ...
            <div className="flex items-center gap-3">
              <Button variant="outline" size="sm" className="border-gray-600 hover:bg-white/5 text-white">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-white">
                      ${(financialMetrics.totalRevenue.value / 1000000).toFixed(2)}M
                    </p>
                    <div className="flex items-center gap-1 mt-1">
                      <TrendingUp className="w-4 h-4 text-green-400" />
                      <span className="text-green-400 text-sm">+{financialMetrics.totalRevenue.change}%</span>
                      <span className="text-gray-500 text-sm">{financialMetrics.totalRevenue.period}</span>
                    </div>
                  </div>
          ...
          >
            <Card className="bg-gray-900 border-gray-800">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-gray-400 text-sm font-medium">Monthly Burn Rate</p>
                    <p className="text-2xl font-bold text-white">
                      ${(financialMetrics.burnRate.value / 1000).toFixed(0)}K
                    </p>
                    <div className="flex items-center gap-1 mt-1">
                      <TrendingDown className="w-4 h-4 text-green-400" />
                      <span className="text-green-400 text-sm">{financialMetrics.burnRate.change}%</span>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-white">{financialMetrics.runway.months} months</p>
                    <div className="flex items-center gap-1 mt-1">
                      <Calendar className="w-4 h-4 text-yellow-400" />
                      <span className="text-yellow-400 text-sm">At current burn</span>
                    </div>
                  </div>
          ...
          >
            <Card className="bg-gray-900 border-gray-800">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-gray-400 text-sm font-medium">Current Headcount</p>
                    <p className="text-2xl font-bold text-white">{headcountData[headcountData.length - 1].count}</p>
                    <div className="flex items-center gap-1 mt-1">
                      <TrendingUp className="w-4 h-4 text-blue-400" />
                      <span className="text-blue-400 text-sm">
                        +{headcountData[headcountData.length - 1].count - headcountData[0].count}
                      </span>
                    ...
                    <div key={expense.category} className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          <span className="text-white">${(expense.amount / 1000).toFixed(0)}K</span>
                          <Badge
                            variant="outline"
                            className={`${
                              expense.change > 0
                      ...
                      <div className="text-sm text-gray-400">{expense.percentage}% of total expenses</div>
                    </div>
                  ))}
                </div>
              </CardContent>
                ...
                <div className="space-y-4">
                    ...
                    {headcountData.map((data) => (
                      <div key={data.month} className="flex flex-col items-center gap-2">
                        <div
                          ...
                          style={{ height: `${(data.count / Math.max(...headcountData.map((d) => d.count))) * 100}%` }}
                        />
                  ...
                  <div className="text-center">
                    <p className="text-sm text-gray-400">
                      Average growth: <span className="text-white font-medium">3.2 employees/month</span>
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent>
                <div className="space-y-4">
                  {secUpdates.map((update) => (
                    <div key={update.id} className="border-l-2 border-gray-700 pl-4 space-y-2">
            ...
            <CardContent>
              <div className="grid md:grid-cols-3 gap-4">
                {industryNews.map((news) => (
                  <div key={news.id} className="bg-gray-800/50 rounded-lg p-4 space-y-3">
                    <div className="flex items-start justify-between">
                      <Badge
                        variant="outline"
                        className={`${
